...
const LoginPage = () => {
    ...
    return (
        ...
        bg-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
            ...
            flex-col rounded-lg shadow-lg gap-5 '>
            ...
            {currState === 'Sign up' && isDataSubmitted && (
                ...
                focus:ring-indigo-500' placeholder='Provide a short bio...' rows={4} required/>
            )}

            <button type='submit' className=' py-3 bg-gradient-to-r from-purple-400 to-violet-500
            ...
            <div className=' flex items-center text-sm text-gray-400'>
                <input type='checkbox'/> 
                <p> Agree to the Terms of Service &  Privacy Policy</p>
            </div>

            <div className='flex flex-col gap-2 '>
                {currState === 'Sign up' ? (
                    <p className='text-sm text-gray-600'> Already have an account ? 
                    <span onClick={() => {setCurrState("Login"); setIsDataSubmitted(false)}} className='font-medium 
                    text-violet-500 cursor-pointer'> Login here</span></p>
                ): (
                    <p className='text-sm text-gray-600'>Create an account. 
                    <span onClick={() => setCurrState("Sign up")} className='font-medium text-violet-500 
