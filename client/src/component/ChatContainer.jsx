...
const ChatContainer = () => {
    ...
    return selectedUser ? (
            <div className="flex-1 flex flex-col overflow-y-scroll p-3 pb-18 relative">
                ...
                {messages.map((msg, index) => (
                    ...
                    {msg.image ? (
                        ...
                        border-gray-700 rounded-lg overflow-hidden mb-8' />
                            ...
                            <p className={`max-w-[200px] p-2  rounded-lg  text-sm font-light mb-8 
            ...
            <div className='  absolute bottom-0 left-0 right-0 flex items-center p-3   '>
                <div className= ' flex-1 flex items-center bg-gray-100/12 px-3  rounded-full'>
                    ...
                    onKeyDown={(e) => e.key === "Enter" ? handleSendMessage(e) : null } className=' flex-1 text-sm p-3 border-none 
